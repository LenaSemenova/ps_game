...
const lightModeMainPage = (req, res) => {
    const lang = req.params.lang;
    if (lang === 'ru') {
...
const lightModeRegistrationPage = (req, res) => {
    const lang = req.params.lang;
    if (lang === 'ru') {
...
const lightModeAddNewPlayer = async(req, res) => {
    let newPlayer = {};
    let playerID; 
    console.log('Check if this email is already in the database');
    const data = req.body;
...
const lightModeNewQuestion = async(req, res) => {
    const playerID = req.params.player_id;
    const lang = req.params.lang;
    try {
        const player_data = await DB_GENERAL.aboutPlayer(playerID);
...
const lightModeBuildFeedback = async(req, res) => {
...
const lightModeRenderFinalResult = async(req, res) => {
    const playerID = req.params.player_id;
    const lang = req.params.lang;
    try {
    const playerInfo = await DB_GENERAL.aboutPlayer(playerID);
...
export default {
    ...
    lightModeMainPage,
    registrationPage,
    lightModeRegistrationPage,
    addNewPlayer, 
    lightModeAddNewPlayer,
    newQuestion,
    lightModeNewQuestion,
    buildFeedback, 
    lightModeBuildFeedback,
    renderFinalResult,
    lightModeRenderFinalResult
}